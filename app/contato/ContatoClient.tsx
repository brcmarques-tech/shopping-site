...
// KAN-219: content vem por prop do Server Component (page.tsx). Antes era fetch
// client-side, escondendo os dados de contato reais do crawler.
export default function ContatoClient({ content }: { content: SiteContent }) {
