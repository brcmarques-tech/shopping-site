...
// KAN-219: content agora vem por prop do Server Component (page.tsx), que busca
// getSiteContent() no servidor. Antes era fetch client-side via useEffect, o que
// deixava o crawler/SSR ver so os defaults + causava flash/CLS no hero.
